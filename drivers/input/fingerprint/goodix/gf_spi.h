...
#define GF_NAV_INPUT_CLICK		KEY_F17  //KEY_VOLUMEDOWN
#define GF_NAV_INPUT_DOUBLE_CLICK	      KEY_F18        //KEY_VOLUMEUP
#define GF_NAV_INPUT_LONG_PRESS		KEY_F19   //KEY_SEARCH
